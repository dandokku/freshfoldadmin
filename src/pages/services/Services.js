...
export default function Services() {
   ...
   const columns = React.useMemo(() => [
    ...
    {field: "serviceName", headerName: "Service Name", width: 170, maxWidth: 170, editable: true,},
    {field: "description", headerName: "Description", width: 250, maxWidth: 250, editable: true,},
   ...
   async function deletePrice(){
    ...
    return (
        <Container>
            ...
            <PricesDiv>
                    <span className="btn-mask">Add Service</span>
                    <PricesLink to="/dashboard/services/add-service">Add Service</PricesLink>
            </PricesDiv>
