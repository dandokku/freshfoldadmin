...
export default function AddPrice() {
    ...
    function handleSubmit(e) {
        e.preventDefault();
        if(!validateFieldsData.group && !validateFieldsData.name && !validateFieldsData.price){
            mutate({
                ...fieldsData,
            })
        }
    ...
    async function postPrices(price){
            ...
            <Form onSubmit={handleSubmit}>
                    ...
                    <div>
                        <div className="user-info">
                            <label>Name</label>
                            <input required={true}
                                type="text" max={200} className='input-field' name="name" onChange={handleInputChange} 
                            />
                            {validateFieldsData.name && validateFieldsData.name}
                        </div>
                        <div className="user-info">
                            <label>Group</label>
                            <input required={true}
                                    type="text" max={200} className='input-field' name="group" onChange={handleInputChange} 
                            />
                            {validateFieldsData.group && validateFieldsData.group}
                        </div>
                    </div>
                    ...
                    <div>
                        <div className="user-info">
                            ...
                            <input required={true}
                                    type="number"
                                    name="price"  min={1} max={200} className='input-field' 
                                    onChange={handleInputChange}
                            />
                            {validateFieldsData.price && validateFieldsData.price}
                        </div>
